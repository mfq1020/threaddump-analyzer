package site.hearen.thread.dump.analyzer.vo;

import lombok.AllArgsConstructor;
import lombok.Builder;
import lombok.Data;
import lombok.NoArgsConstructor;
import site.hearen.thread.dump.analyzer.util.DeadLockCounter;
import site.hearen.thread.dump.analyzer.util.TreeNode;
